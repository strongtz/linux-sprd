...
#ifndef __SPRD_AUDIO_SHARKLE_H
#define __SPRD_AUDIO_SHARKLE_H
...
#define DMA_REQ_ARM7_VBC_DA0            (4 + 1)
#define DMA_REQ_ARM7_VBC_DA1            (5 + 1)
#define DMA_REQ_ARM7_VBC_DA2            (6 + 1)
#define DMA_REQ_ARM7_VBC_DA3            (7 + 1)
