...
enum isp_block {
	ISP_BLOCK_1D_LSC,/*TODO: use radial_lsc instead*/
	ISP_BLOCK_2D_LSC,
...
/* TODO:  use radial_lsc instead */
enum isp_1d_lsc_property {
	ISP_PRO_1D_LSC_BLOCK,
};

/*isp sub block: rlsc (1d_lsc)*/
...
/* TODO:  using radial_lsc instead of 1d_lsc*/
...
struct isp_dev_fetch_info {
	...
	/* the word number of a row in mipi inpu format */
	unsigned int mipi_word_num;
	/* relative position of 1st pixel in first 5 word of each row */
...
enum isp_statis_valid_type {
	...
	ISP_STATIS_VALID_BINNING = (1 << 3),
	ISP_STATIS_VALID_PDAF = (1 << 4),
