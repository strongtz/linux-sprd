...
/* Global config reg */
#define R8P0_GSP_GLB_CFG(base)		(base + 0x1000)
#define R8P0_GSP_INT(base)		(base + 0x004 + 0x1000)
...
#define R8P0_DES_V_ADDR(base)		(base + 0x01C + 0x1000)
#define R8P0_DES_PITCH(base)		(base + 0x020 + 0x1000)
#define R8P0_BACK_RGB(base)		(base + 0x024 + 0x1000)
...
#define R8P0_LIMG_V_ADDR(base)		(base + 0x03C + 0x1000)
#define R8P0_LIMG_PITCH(base)		(base + 0x040 + 0x1000)
#define R8P0_LIMG_CLIP_START(base)	(base + 0x044 + 0x1000)
#define R8P0_LIMG_CLIP_SIZE(base)	(base + 0x048 + 0x1000)
#define R8P0_LIMG_DES_START(base)	(base + 0x04C + 0x1000)
#define R8P0_LIMG_PALLET_RGB(base)	(base + 0x050 + 0x1000)
#define R8P0_LIMG_CK(base)		(base + 0x054 + 0x1000)
#define R8P0_Y2Y_Y_PARAM(base)		(base + 0x058 + 0x1000)
#define R8P0_Y2Y_U_PARAM(base)		(base + 0x05C + 0x1000)
#define R8P0_Y2Y_V_PARAM(base)		(base + 0x060 + 0x1000)
#define R8P0_LIMG_DES_SIZE(base)	(base + 0x064 + 0x1000)
...
#define R8P0_LOSD_CLIP_START(base)	(base + 0x0BC + 0x1000)
#define R8P0_LOSD_CLIP_SIZE(base)	(base + 0x0C0 + 0x1000)
#define R8P0_LOSD_DES_START(base)	(base + 0x0C4 + 0x1000)
#define R8P0_LOSD_PALLET_RGB(base)	(base + 0x0C8 + 0x1000)
#define R8P0_LOSD_CK(base)		(base + 0x0CC + 0x1000)

#define R8P0_LOSD_BASE_ADDR(base)	(base + 0x0B0 + 0x1000)
#define R8P0_LOSD_OFFSET 0x020
#define R8P0_LOSD_SEC_ADDR(base)	(base + 0x0D0 + 0x1000)

#define R8P0_DES_DATA_CFG1(base)	(base + 0x0F0 + 0x1000)
#define R8P0_DES_Y_ADDR1(base)		(base + 0x0F4 + 0x1000)
#define R8P0_DES_U_ADDR1(base)		(base + 0x0F8 + 0x1000)
#define R8P0_DES_V_ADDR1(base)		(base + 0x0FC + 0x1000)
#define R8P0_DES_PITCH1(base)		(base + 0x100 + 0x1000)

#define R8P0_GSP_IP_REV(base)		(base + 0x204 + 0x1000)
#define R8P0_GSP_DEBUG_CFG(base)	(base + 0x208 + 0x1000)
#define R8P0_GSP_DEBUG1(base)		(base + 0x20C + 0x1000)
#define R8P0_GSP_DEBUG2(base)		(base + 0x210 + 0x1000)

#define R8P0_SCALE_COEF_ADDR(base)	(base + 0x300 + 0x1000)
