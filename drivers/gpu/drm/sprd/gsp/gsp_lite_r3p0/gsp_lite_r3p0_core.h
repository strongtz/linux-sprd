...
#define LITE_R3P0_GSP_COEF_CACHE_MAX		 32
...
int gsp_lite_r3p0_core_copy_cfg(struct gsp_kcfg *kcfg, void *arg, int index);
...
int gsp_lite_r3p0_core_trigger(struct gsp_core *core);

int gsp_lite_r3p0_core_enable(struct gsp_core *core);

void gsp_lite_r3p0_core_disable(struct gsp_core *core);

int gsp_lite_r3p0_core_release(struct gsp_core *core);

int __user *gsp_lite_r3p0_core_intercept(void __user *arg, int index);
void gsp_lite_r3p0_core_reset(struct gsp_core *core);
void gsp_lite_r3p0_core_dump(struct gsp_core *core);
