#ifndef __KTD3137_H__
#define __KTD3137_H__
...
#define RESET_CONDITION_BITS		(BIT_CH3_FAULT | \
					BIT_CH2_FAULT | \
					BIT_CH1_FAULT | \
					BIT_OVP | BIT_OCP)

#define KTD_I2C_NAME			"ktd3137"
#define DEFAULT_PWM_NAME		"ktd-backlight"
#define KTD3137_NAME			"ktd3137_bl"

struct ktd3137_bl_data {
	bool pwm_mode;
	bool using_lsb;
	bool using_linear;
...
#ifdef KTD3133_USE_PINCTRL
	struct pinctrl *ktd_pinctrl;
