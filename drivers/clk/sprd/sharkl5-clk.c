...
//
// Spreatrum Sharkl5 clock driver
//
...
static struct sprd_clk_common *sharkl5_pmu_gate_clks[] = {
...
static struct sprd_clk_desc sharkl5_pmu_gate_desc = {
	.clk_clks	= sharkl5_pmu_gate_clks,
	.num_clk_clks	= ARRAY_SIZE(sharkl5_pmu_gate_clks),
	.hw_clks        = &sharkl5_pmu_gate_hws,
};
...
static struct sprd_clk_common *sharkl5_g0_pll_clks[] = {
	/* address base is 0x32390000 */
	&dpll0_clk.common,
};

static struct clk_hw_onecell_data sharkl5_g0_pll_hws = {
	.hws	= {
...
static struct sprd_clk_desc sharkl5_g0_pll_desc = {
	.clk_clks	= sharkl5_g0_pll_clks,
	.num_clk_clks	= ARRAY_SIZE(sharkl5_g0_pll_clks),
	.hw_clks	= &sharkl5_g0_pll_hws,
};
...
static struct sprd_clk_common *sharkl5_g2_pll_clks[] = {
	/* address base is 0x323B0000 */
	&mpll1_clk.common,
};

static struct clk_hw_onecell_data sharkl5_g2_pll_hws = {
	.hws	= {
...
static struct sprd_clk_desc sharkl5_g2_pll_desc = {
	.clk_clks	= sharkl5_g2_pll_clks,
	.num_clk_clks	= ARRAY_SIZE(sharkl5_g2_pll_clks),
	.hw_clks	= &sharkl5_g2_pll_hws,
};
...
static struct sprd_clk_desc sharkl5_g3_pll_desc = {
	.clk_clks	= sharkl5_g3_pll_clks,
	.num_clk_clks	= ARRAY_SIZE(sharkl5_g3_pll_clks),
	.hw_clks	= &sharkl5_g3_pll_hws,
};
...
static struct clk_hw_onecell_data sharkl5_gc_pll_hws = {
	.hws	= {
...
static struct sprd_clk_desc sharkl5_gc_pll_desc = {
	.clk_clks	= sharkl5_gc_pll_clks,
	.num_clk_clks	= ARRAY_SIZE(sharkl5_gc_pll_clks),
...
static struct sprd_clk_common *sharkl5_ap_clks[] = {
...
static struct clk_hw_onecell_data sharkl5_ap_clk_hws = {
	.hws	= {
...
static struct sprd_clk_desc sharkl5_ap_clk_desc = {
	.clk_clks	= sharkl5_ap_clks,
	.num_clk_clks	= ARRAY_SIZE(sharkl5_ap_clks),
	.hw_clks	= &sharkl5_ap_clk_hws,
};
...
static const char * const aux_parents[] = { "ext-32k", "ext-26m", "ext-26m-aud",
					    "rco-25m", "cppll-39m32",
					    "mpll0-56m88", "mpll1-63m38",
					    "mpll2-47m13", "dpll0-58m31",
					    "gpll-40m", "twpll-48m"};
...
static const char * const apcpu_ts_parents[] = { "ext-32k", "ext-26m", "twpll-128m",
					"twpll-153m6" };
...
static const char * const emc_parents[] = { "ext-26m", "twpll-384m", "twpll-512m",
					"twpll-768m" };
...
static struct sprd_clk_common *sharkl5_aon_apb[] = {
...
static struct clk_hw_onecell_data sharkl5_aon_apb_hws = {
	.hws	= {
...
static struct sprd_clk_desc sharkl5_aon_apb_desc = {
	.clk_clks	= sharkl5_aon_apb,
	.num_clk_clks	= ARRAY_SIZE(sharkl5_aon_apb),
...
static struct clk_hw_onecell_data sharkl5_mm_clk_hws = {
	.hws	= {
...
static struct sprd_clk_desc sharkl5_mm_clk_desc = {
...
static SPRD_SC_GATE_CLK(vsp_eb,		"vsp-eb",	"ext-26m", 0x0,
		     0x1000, BIT(2), CLK_IGNORE_UNUSED, 0);
static SPRD_SC_GATE_CLK(dma_enable,	"dma-enable",	"ext-26m", 0x0,
		     0x1000, BIT(4), CLK_IGNORE_UNUSED, 0);
static SPRD_SC_GATE_CLK(dma_eb,		"dma-eb",	"ext-26m", 0x0,
		     0x1000, BIT(5), CLK_IGNORE_UNUSED, 0);

static struct sprd_clk_common *sharkl5_apahb_gate[] = {
...
static struct clk_hw_onecell_data sharkl5_apahb_gate_hws = {
	.hws	= {
		[CLK_DSI_EB]		= &dsi_eb.common.hw,
		[CLK_DISPC_EB]		= &dispc_eb.common.hw,
		[CLK_VSP_EB]		= &vsp_eb.common.hw,
		[CLK_DMA_PUB_EB]	= &dma_enable.common.hw,
		[CLK_DMA_EB]		= &dma_eb.common.hw,
	},
	.num	= CLK_AP_AHB_GATE_NUM,
};

static struct sprd_clk_desc sharkl5_apahb_gate_desc = {
	.clk_clks	= sharkl5_apahb_gate,
	.num_clk_clks	= ARRAY_SIZE(sharkl5_apahb_gate),
	.hw_clks	= &sharkl5_apahb_gate_hws,
};
...
static struct sprd_clk_common *sharkl5_aon_gate[] = {
...
static struct clk_hw_onecell_data sharkl5_aon_gate_hws = {
	.hws	= {
...
static struct sprd_clk_desc sharkl5_aon_gate_desc = {
	.clk_clks	= sharkl5_aon_gate,
	.num_clk_clks	= ARRAY_SIZE(sharkl5_aon_gate),
	.hw_clks	= &sharkl5_aon_gate_hws,
};
...
static struct sprd_clk_common *sharkl5_apapb_gate[] = {
...
static struct clk_hw_onecell_data sharkl5_apapb_gate_hws = {
	.hws	= {
...
static struct sprd_clk_desc sharkl5_apapb_gate_desc = {
	.clk_clks	= sharkl5_apapb_gate,
	.num_clk_clks	= ARRAY_SIZE(sharkl5_apapb_gate),
	.hw_clks	= &sharkl5_apapb_gate_hws,
};

static const struct of_device_id sprd_sharkl5_clk_ids[] = {
	{ .compatible = "sprd,sharkl5-apahb-gate",	/* 0x20100000 */
	  .data = &sharkl5_apahb_gate_desc },
	{ .compatible = "sprd,sharkl5-ap-clk",	/* 0x20200000 */
	  .data = &sharkl5_ap_clk_desc },
	{ .compatible = "sprd,sharkl5-aonapb-clk",	/* 0x32080200 */
	  .data = &sharkl5_aon_apb_desc },
	{ .compatible = "sprd,sharkl5-aon-gate",	/* 0x327d0000 */
	  .data = &sharkl5_aon_gate_desc },
	{ .compatible = "sprd,sharkl5-pmu-gate",	/* 0x327e0000 */
	  .data = &sharkl5_pmu_gate_desc },
	{ .compatible = "sprd,sharkl5-g0-pll",		/* 0x32390000 */
	  .data = &sharkl5_g0_pll_desc },
	{ .compatible = "sprd,sharkl5-g2-pll",		/* 0x323b0000 */
	  .data = &sharkl5_g2_pll_desc },
	{ .compatible = "sprd,sharkl5-g3-pll",		/* 0x323c0000 */
...
MODULE_DEVICE_TABLE(of, sprd_sharkl5_clk_ids);

static int sharkl5_clk_probe(struct platform_device *pdev)
{
	const struct of_device_id *match;
	const struct sprd_clk_desc *desc;
	int ret;

	match = of_match_node(sprd_sharkl5_clk_ids, pdev->dev.of_node);
	if (!match) {
...
static struct platform_driver sharkl5_clk_driver = {
	.probe	= sharkl5_clk_probe,
	.driver	= {
		.name	= "sharkl5-clk",
		.of_match_table	= sprd_sharkl5_clk_ids,
	},
};
module_platform_driver(sharkl5_clk_driver);

MODULE_DESCRIPTION("Spreadtrum Sharkl5 Clock Driver");
MODULE_LICENSE("GPL v2");
MODULE_ALIAS("platform:sharkl5-clk");
